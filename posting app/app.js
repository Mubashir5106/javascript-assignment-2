...
function postingInpValue() {
    ...
    <div class="title">
        <div class="name-sec">
            <img class="user-image" width="40px" height="40px" src="images/my-pic.jpg" alt="" srcset="">
            <div class="time">
                <p class="name">MUBASHIR AHMED
                <p id="time">${date}</p>
                </p>
            </div>
    ...
    <div id="comment-box">
        <img class="user-image" width="40px" height="40px" src="images/my-Pic.jpg" alt="">
    ...
    <div id="comment">
        ...
        document.getElementById("error-message").innerHTML = "*Post Cannot be Submitted Its Empty"
