...
//     fetch(`https://api.openweathermap.org/data/2.5/weather?q${input_data}&appid=6ff328ae0c9140a17f884382f6e36a59&units=metric`)
    const data_result = input_data => {
        const getting_api = new Promise((resolve, reject) => {
            fetch(`https://api.openweathermap.org/data/2.5/weather?q=${input_data}&appid=8976e24c4d6de353e9e67b34bf68a79c&units=metric`)
